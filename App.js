...
const HomeScreen = ({ navigation }) => {
  return (
    ...
    <SafeAreaView style={[styles.navBarTop]}>
        <ImageBackground source={require('./bluebanner.jpg')}  style={styles.banner}>
      ...
      <Pressable style ={[styles.buttonHome]} title="Toggle Lock" onPress={unlockPress}>
      <Text style={[styles.buttonText]}>
        Toggle Lock
      </Text>
      </Pressable>
      <Pressable style ={[styles.buttonHome]} title="Sign Up" onPress={() => navigation.navigate('Sign Up')}>
      <Text style={[styles.buttonText]}>
        Sign Up
      </Text>
      </Pressable>
      <Pressable style ={[styles.buttonHome]} title="Sign In" onPress={() => navigation.navigate('Sign In')}>
      <Text style={[styles.buttonText]}>
        Sign In
      </Text>
      </Pressable>
      <Pressable style ={[styles.buttonHome]} title="Go to Admin Page" onPress={() => navigation.navigate('Admin')}>
      <Text style={[styles.buttonText]}>
        Admin Page
      </Text>
      </Pressable>
...
const settingsScreen = ({navigation,route}) => {
  return ( <SafeAreaView style={[styles.containerAdmin, {
